...
def register():
    if request.method == 'POST':
        ...
        new_user = User(SSN=ssn, first_name=first_name, middle_name=middle_name, last_name=last_name, phone=phone, password=password, isVerified=False)
...
def login():
    if request.method == 'POST':
        ...
        if user and check_password_hash(user.password, password):
            ...
            return redirect(url_for('index'))  # Redirect to homepage or a user dashboard
        else:
